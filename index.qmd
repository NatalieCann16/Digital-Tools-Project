...
![](index_png/frontpagebanneralt.png)
...
tags$div(
  style = "margin-top:8px; padding:6px; border-radius:8px; 
           background-color:#BCE8D9; width:90%; text-align:center;
...
tags$div(
  style = "margin-top:15px; padding:15px; border-radius:8px; 
           background-color:#BCE8D9; width:100%; 
           box-shadow:0 2px 5px rgba(0,0,0,0.1); font-family:Arial;",
...
tags$div(
  style = "margin-top:15px; padding:15px; border-radius:8px; 
           background-color:#C4E2F3; width:100%; 
           box-shadow:0 2px 5px rgba(0,0,0,0.1); font-family:Arial;",
...
<img src="index_png/ticketraffle.png" alt="" style="float: right; margin-left: 20px; width: 300px;">
